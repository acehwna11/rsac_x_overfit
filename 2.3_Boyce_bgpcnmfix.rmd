...
model_rndcv4k.pcnm_reptile[[1]]@data@data[model_rndcv4k.pcnm_reptile[[1]]@data@pa==0,]
...
for(i in 1:length(model_rndcv4k.pcnm_reptile)){
  RESPONSE.rndcv4k.pcnm_reptile[[i]] <- 
                        list(SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[1], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[2], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[3], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[4], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[5], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[6], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[7], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[8], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[9], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[10], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[11], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[12], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[13], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[14], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[15], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[16], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[17], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[18], type = "raw"),
                             SDMtune::plotResponse(model_rndcv4k.pcnm_reptile[[i]], var = names(model_rndcv4k.pcnm_reptile[[i]]@data@data)[19], type = "raw"))}
